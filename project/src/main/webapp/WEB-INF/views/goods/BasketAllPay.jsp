...
<body>
	...
	<center>
		<form action="BasketAllProc" method="get">
			<font size="6"><%=memid%>님의 장바구니</font>
			<div style="width: 1000px;">
				<table class="table table-boared">
					...
					<tr height="80">
						<td colspan="2" width="50%" align="center"><h3>배송지</h3></td>
						<td colspan="3" align="left"><br> <input type="text"
					...
					<tr height="80">
						...
						<td colspan="3" align="left"><br> <input type="text"
							name="claim" class="form-control"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="5" width="50%" align="right"><h3>
								사용할 마일리지 : <input type="text" name="usePoint" value="0" size="3">
							</h3></td>
					</tr>
					<tr>
						<td colspan="5" width="50%" align="right"><h3>
					...
					<tr>
						<td colspan="5" width="50%" align="center"><input
							type="hidden" name="sumPrice" value="${sumPrice}"> <input
							type="submit" class="btn btn-success" value="전체 구매">&nbsp;&nbsp;&nbsp;
							<input type="button" class="btn btn-success"
							onclick="location.href='Basket'" value="이전 페이지로"></td>
					</tr>
				</table>
			</div>
		</form>
